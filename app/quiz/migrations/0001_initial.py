# Generated by Django 2.2.19 on 2022-12-06 01:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quiz', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='quizes_answers', to='quiz.Quiz', verbose_name='Quiz')),
            ],
        ),
    ]
